...
* В работе использован фреймворк React.js, что позволяет существенно сократить и систематизировать [код из предыдущей работы](https://github.com/sashamehaev/mesto)
